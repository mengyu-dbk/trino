        ...
        implements RecordSet
{
            ...
            List<ReadServiceColumnHandle> columnHandles)
    {
        ...
        for (ReadServiceColumnHandle column : columnHandles) {
    ...
    {
        return new ReadServiceRecordCursor(client, split, columnHandles);
    }
}
